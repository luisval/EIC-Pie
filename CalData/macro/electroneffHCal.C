...
TFile *file1 = TFile::Open("Epcut_G4EICDetector_out_hq2_e_0.5-1GeV.root");
...
TCanvas *c2 = new TCanvas("c5","HCal efficiency of #e^{-}",200,10,500,300);
  ...
  TMultiGraph *mg = new TMultiGraph();
      ...
      mg->GetXaxis()->SetLimits(0.005, 0.020);
...
//  gr1->SetPoint(3,0.3,eff8_e);
  gr1->SetPoint(4,0.006,eff7_e);
  gr1->SetPoint(5,0.008,eff6_e); 
  gr1->SetPoint(6,0.010,eff5_e);
  gr1->SetPoint(7,0.012,eff4_e);
  gr1->SetPoint(8,0.014,eff3_e);
  gr1->SetPoint(9,0.016,eff2_e);
  gr1->SetPoint(10,0.018,eff1_e);

  gr2->SetPoint(4,0.006,eff7_e2);
  gr2->SetPoint(5,0.008,eff6_e2); 
  gr2->SetPoint(6,0.010,eff5_e2);
  gr2->SetPoint(7,0.012,eff4_e2);
  gr2->SetPoint(8,0.014,eff3_e2);
  gr2->SetPoint(9,0.016,eff2_e2);
  gr2->SetPoint(10,0.018,eff1_e2);

  gr3->SetPoint(4,0.006,eff7_e3);
  gr3->SetPoint(5,0.008,eff6_e3); 
  gr3->SetPoint(6,0.010,eff5_e3);
  gr3->SetPoint(7,0.012,eff4_e3);
  gr3->SetPoint(8,0.014,eff3_e3);
  gr3->SetPoint(9,0.016,eff2_e3);
  gr3->SetPoint(10,0.018,eff1_e3);

  gr4->SetPoint(4,0.006,eff7_e4);
  gr4->SetPoint(5,0.008,eff6_e4); 
  gr4->SetPoint(6,0.010,eff5_e4);
  gr4->SetPoint(7,0.012,eff4_e4);
  gr4->SetPoint(8,0.014,eff3_e4);
  gr4->SetPoint(9,0.016,eff2_e4);
  gr4->SetPoint(10,0.018,eff1_e4);
